...
class invB(nn.Module):
    ...
    def __init__(self, base, b=False, drop_p=0.0, attn=False):
        ...
        if attn:
            self.compress = Attn(36 * base, 24 * base, 2, b=b) if N == 16 else Attn(36 * base, 24 * base, 1, b=b)
        else:
...
class invA(nn.Module):
    ...
    def __init__(self, base, b=False, drop_p=0.0, attn=False):
        ...
        if attn:
            self.compress = Attn(16 * base, 12 * base, 4, b=b) if N == 16 else Attn(16 * base, 12 * base, 2, b=b)
        else:
...
class Simple(nn.Module):
    ...
    def forward(self, x):
        ...
        is1 = self.is1(is2, s1, s1.shape[3:])
